    ...
    <div class="card p-3">
        <div class="table-responsive">
            <table class="table align-middle">
                ...
                <tbody>
                    <?php $__currentLoopData = $empleos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <div class="fw-bold"><?php echo e($e->Descripcion); ?></div>
                        </td>
                        <td>
                            <span class="badge bg-light text-dark border">
                                <i class="far fa-clock text-primary me-1"></i> <?php echo e($e->Turno); ?>

                            </span>
                        </td>
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <button type="button" class="btn-action btn-edit" data-bs-toggle="modal" data-bs-target="#editModal<?php echo e($e->IdEmpleo); ?>" title="Editar">
                                    <i class="fas fa-edit small"></i>
                                </button>

                                <form action="<?php echo e(route('empleos.destroy', $e->IdEmpleo)); ?>" method="POST" onsubmit="return confirm('¿Eliminar <?php echo e($e->Descripcion); ?>?')">
                                    <?php echo csrf_field(); ?>
                            ...
                            <div class="modal fade" id="editModal<?php echo e($e->IdEmpleo); ?>" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content border-0 shadow">
                                        ...
                                        <form action="<?php echo e(route('empleos.update', $e->IdEmpleo)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <div class="modal-body text-start">
                                                <div class="mb-3">
                                                    <label class="small fw-bold">Descripción</label>
                                                    <input type="text" name="Descripcion" value="<?php echo e($e->Descripcion); ?>" class="form-control" placeholder="Ej: Gerente" required>
                                                </div>
                                                <div class="mb-0">
                                                    <label class="small fw-bold">Turno</label>
                                                    <input type="text" name="Turno" value="<?php echo e($e->Turno); ?>" class="form-control" placeholder="Ingrese su turno" required>
                                                </div>
                                            </div>
...
<div class="modal fade" id="modalNuevoEmpleo" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <form action="<?php echo e(route('empleos.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\wamp64\www\mi-web\resources\views/empleos.blade.php ENDPATH**/ ?>