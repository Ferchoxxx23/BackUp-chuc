        ...
        <div class="table-responsive">
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="fw-bold">{{ $p->Nombre }} {{ $p->Apellido }}</div>
                            <div class="small text-muted"><i class="fas fa-home me-1"></i> {{ $p->Direccion }}</div>
                        </td>
                        <td>
                            <span class="badge bg-light text-dark border">
                                <i class="fas fa-map-marker-alt text-danger me-1"></i>{{ $p->Localidad }}
                            </span>
                        </td>
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <button type="button" class="btn-action btn-edit" data-bs-toggle="modal" data-bs-target="#editModal{{ $p->IdPersona }}" title="Editar">
                                    <i class="fas fa-edit small"></i>
                                </button>

                                <form action="{{ route('personas.destroy', $p->IdPersona) }}" method="POST" onsubmit="return confirm('¿Eliminar a {{ $p->Nombre }}?')">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <div class="modal fade" id="editModal{{ $p->IdPersona }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content border-0 shadow">
                                        ...
                                        <form action="{{ route('personas.update', $p->IdPersona) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-body text-start">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" name="Apellido" value="{{ $p->Apellido }}" class="form-control" required>
                                                </div>
                                                <div class="mb-2">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <input type="text" name="Localidad" value="{{ $p->Localidad }}" class="form-control" required>
                                                </div>
                                            </div>
...
<div class="modal fade" id="modalPersona" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <form action="{{ route('backup.insert') }}" method="POST">
                @csrf 
